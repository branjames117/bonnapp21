      ...
      <div>
        <Card>
          ...
          <p className={classes.body}>
            ...
            Bonnaroovians for the cost of nothing. Maybe hug me if you see me at
            Centeroo.
          </p>
          <h2 className={classes.h2} style={{ color: randomColorGenerator() }}>
            But What's It Do
          ...
          <p className={classes.body}>
            You can check out the <Link href='/lineup'>Lineup</Link> for quick
        ...
        <Card>
          ...
          <p className={classes.body}>
            ...
            Superfly Presents, or AC Entertainment. Their official website is at{' '}
            <Link href='https://www.bonnaroo.com/'>bonnaroo.com</Link>, where
            you'll find all the official information.
          </p>
          <p className={classes.body}>
            ...
            , or are in the public domain, with author attribution in the alt
            and title attributes of each image tag.
          </p>
        </Card>
      </div>
      <div>
        {(!session && (
          <Card>
            ...
            <p className={classes.body}>
              <Link href='/users/register'>Register</Link> an account with only
              a username and a password to gain access to the app's social
        ...
        <Card>
          ...
          <p className={classes.body}>
            Mainly, spread the word and get your friends registered to the site.
            But you can also help by assisting me in refining the database. If a
            performer was incorrectly documented, such as incorrect genre
            identification (I used wikipedia for the most part, but sometimes
            had to seek other sources when wikipedia pages weren't available),
            or if you feel a selected video doesn't accurately portray the
            performer, or if (OH NO!) something here breaks, then drop me an
            email at{' '}
