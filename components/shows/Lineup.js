  ...
  return (
    <div className={classes.container}>
      <Card>
        ...
        <div className={darkTheme ? classes.darkHeadliner : classes.headliner}>
        ...
        <div className={darkTheme ? classes.darkHeadliner : classes.headliner}>
          <Link href={'/shows/Foo Fighters'}>
            <span className={darkTheme ? '' : classes.green}>Foo Fighters</span>
          </Link>
        ...
        <div className={darkTheme ? classes.darkSubliner : classes.subliner}>
          ...
          <Link href='/shows/Janelle Monae'>
            <span className={darkTheme ? '' : classes.pink}>Janelle Monae</span>
          </Link>
          <Link href='/shows/Glass Animals'>
            <span className={darkTheme ? '' : classes.pink}>Glass Animals</span>
          </Link>
          <Link href='/shows/Deftones'>
            <span className={darkTheme ? '' : classes.pink}>Deftones</span>
          </Link>
        ...
        <div className={darkTheme ? classes.darkSubliner : classes.subliner}>
          ...
          <Link href='/shows/Seven Lions'>
            <span className={darkTheme ? '' : classes.orange}>Seven Lions</span>
          </Link>
        </div>
        ...
        <div className={darkTheme ? classes.dark : classes.who}>
